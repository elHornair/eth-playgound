...
export default {
  ...
  created() {
    ...
    smartContract.methods.name().call((err, result) => (this.tokenName = result));
    smartContract.methods.symbol().call((err, result) => (this.tokenSymbol = result));
    smartContract.methods.totalSupply().call((err, result) => (this.tokenTotalSupply = result));
  }
}
</script>
